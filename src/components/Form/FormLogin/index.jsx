    ...
    return(
        <S.Container>
            <S.Form>
                ...
                <Input nomeInput="" placeholder="Email" type="email" name="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)}/>
            
                <Input nomeInput="" placeholder="Senha" type="password" name="senha" id="senha" value={senha} onChange={(e) => setSenha(e.target.value)}/>
                ...
                <Button className="btnSubmit" onClick="">Criar nova conta</Button>
            </S.Form>
        </S.Container>
    );
}
