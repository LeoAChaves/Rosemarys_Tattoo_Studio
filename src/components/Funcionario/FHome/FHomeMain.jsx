  ...
  return (
    <S.HomeMain>
      <FHomeCard
        ...
        texto="Agendamento"
        onClickVisu={() =>
          navigate("/funcionario/agendamento-view/" + funcionario.ID)
        }
        onClickInse={() =>
          navigate("/funcionario/agendamento/" + funcionario.ID)
        }
      />
      <FHomeCard
        tipo="portfolio"
        texto="Portifólio"
        onClickVisu={() =>
          navigate("/funcionario/portfolio-view/" + funcionario.ID)
        }
      ...
      <FHomeCard
        ...
        texto="Estoque"
        onClickVisu={() =>
          navigate("/funcionario/estoque-view/" + funcionario.ID)
        }
