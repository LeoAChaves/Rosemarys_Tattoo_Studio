...
function EsqueceuSenha({changeTheme}) {
    ...
    return (
        <>
            <Header btnCadastro={{display: "none"}} btnVoltar={{display: "none"}} btnHome={{display: "none"}} btnPortfolio={{display: "none"}} btnSair={{display: "none"}} className={"btn custom-btn styleHeader"} style={style} login="Login" changeTheme={changeTheme}/>
            <S.Container>
                <S.Form>
